...
) : FlowUseCase<CheckRegisterFieldUseCase.Param, UiResult<CheckFieldResult>>(dispatcherProvider.io) {

    override fun buildFlowUseCase(param: Param?): Flow<UiResult<CheckFieldResult>> =
        flow {
            param?.let {
